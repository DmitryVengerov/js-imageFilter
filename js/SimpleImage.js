...
/**
 * [SimplePixel description]
 * @param {[type]} simple_image [description]
 * @param {[type]} x            [description]
 * @param {[type]} y            [description]
 */
SimplePixel = function(simple_image, x, y) {
    /**
     *     Сначала валидируем количество введенных аргументов
     *     затем 
     */
...
SimplePixel.prototype = {
    ...
    getX: function() {
         ...
         *   идет проверка на количество переданных аргументов 
         */
        __SimpleImageUtilities.funCheck('getX', 0, arguments.length);
        return this.x;
    },
